...
with st.sidebar:
    ...
    model = st.selectbox(
        "Model",
        ["gpt-3.5-turbo", "gpt-4-turbo"],  # Removed most expensive models for demo
        index=0
    )
...
with col1:
    ...
    prompt = st.text_area(
        ...
        height=100,
        max_chars=500,  # Enforce character limit
    ...
    # Max tokens (limited for demo)
    max_tokens = st.slider(
        "Max Tokens",
        min_value=50,
        max_value=300,  # Reduced max for demo
        value=150,
        step=25,
...
with col2:
    ...
    if st.session_state.client:
        ...
        st.info("Please configure OPENAI_API_KEY in Streamlit secrets")
